...
export default function ComponentDetailContent({
  ...
  const tabsDefault = activeProject === "CIS@2.0" ? "overview" : "cicd";
  ...
  return (
    <div className="space-y-11">
      ...
      {/* Tabs */}
      <Tabs defaultValue={tabsDefault} className="w-full">
        <TabsList>
        ...
        <TabsContent value="monitoring" className="mt-6">
          <EnhancedMonitoring selectedLandscapeData={selectedLandscapeData} />
        </TabsContent>
